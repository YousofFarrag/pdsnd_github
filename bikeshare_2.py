...
CITY_DATA = {'chicago': '/Users/Research/Udacity/Python/bikeshare-2/chicago.csv',
             'new york city': '/Users/Research/Udacity/Python/bikeshare-2/new_york_city.csv',
             'washington': '/Users/Research/Udacity/Python/bikeshare-2/washington.csv'}
    ...
    while True:
        try:
            ...
            if month not in months and month != 'all':
                print('sorry, we provide only the data for (january, february, march, april, may, june or all\n')
                continue
            else:
                break
        except ValueError:
    ...
    while True:
        try:
            ...
            if day not in days and day != 'all':
                print('Sorry, the day was not written correctly!\n')
                continue
            else:
                break
        except ValueError:
